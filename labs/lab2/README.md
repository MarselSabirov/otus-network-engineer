...
#### Шаг 1. Запишите МАС-адреса сетевых устройств.
  ...
  *  *С компьютера PC-B отправьте эхо-запросы устройствам в сети и просмотрите таблицу МАС-адресов коммутатора.*
       ...
       После отправки широковещательного запроса через протокол ARP, было найдено 2 устройства - Switch S1 и Switch S2. После отправки точечных ping-запросов на S1, S2, PC-A, к списку устройств, отображаемых при повторной отправке запроса по ARP, добавился и PC PC-A.
